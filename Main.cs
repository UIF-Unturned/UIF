	...
	public partial class Main : Form
	{
		...
		private void SearchNameBtn_Click(object sender, EventArgs e)
		{
			if (CurrentFolderPath == null) {
				...
				var items = Core.ParseAll(CurrentFolderPath, i => i.GetKeyValueStr("name").ToLower().Contains(NameTextBox.Text.ToLower()));
		...
		private void SearchIDButton_Click(object sender, EventArgs e)
		{
			if (CurrentFolderPath == null) {
				...
				var items = Core.ParseAll(CurrentFolderPath, i => i.GetKeyValueStr("id") == IDBox.Text);
